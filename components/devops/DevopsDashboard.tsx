      ...
      <main className="w-full min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
        <div className="min-h-screen p-6">
          ...
          <div className="bg-white dark:bg-gray-800 shadow p-6 rounded-xl mb-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Home</h2>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow">
              <h2 className="text-lg font-semibold text-gray-700 dark:text-white">Tiket Saya</h2>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow">
              <h2 className="text-lg font-semibold text-gray-700 dark:text-white">Progress Terbaru</h2>
              <p className="text-sm text-gray-500 dark:text-gray-300">
